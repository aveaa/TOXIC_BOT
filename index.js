...
client.on('message', (message) => {
  ...
  if(command === 'role'){
    ...
    autorole = ['anime', 'civcraft', 'league of legends', 'lol', 'starcraft 2', '18+', 'mafia', 'osu!'],
    autoroleid = ['428094961360175107', '459112609816248321', '461846548993671168', '461846548993671168', '425727854127611904', '425656204732137482', '455021200268066818', '427031352639094804'],
    memrole = [],
